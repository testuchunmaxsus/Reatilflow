...
Fixtures:
  ...
  stock_client   — app dependency override qilingan AsyncClient
  make_user      — har rol uchun AppUser yaratish factory
  make_product   — Product yaratish factory
...
_WAREHOUSE_A = uuid.UUID("aaaaaaaa-1111-0000-0000-000000000001")
_WAREHOUSE_B = uuid.UUID("bbbbbbbb-2222-0000-0000-000000000002")
...
WAREHOUSE_A = _WAREHOUSE_A
WAREHOUSE_B = _WAREHOUSE_B
