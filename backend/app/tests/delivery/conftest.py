"""
Yetkazib berish testlari uchun fixtures — T18.
...
Fixtures:
  ...
  delivery_client — app dependency override qilingan AsyncClient
  ...
  admin_user, agent_user, courier_user, store_user, accountant_user
"""
