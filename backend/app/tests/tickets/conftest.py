"""
Tickets testlari uchun fixtures — T24.
...
Fixtures:
  ...
  tickets_client   — app dependency override qilingan AsyncClient
  make_user        — har rol uchun AppUser yaratish factory
  make_store       — Store yaratish factory
  make_agent_store — AgentStore (agent↔do'kon) yaratish factory
  make_ticket      — Ticket yaratish factory
...
def make_ticket(db_session: AsyncSession):
    ...
    async def _factory(
        ...
        ticket_type: str = "taklif",
        subject: str = "Test mavzu",
        body: str = "Test murojaat matni",
        status: str = "new",
